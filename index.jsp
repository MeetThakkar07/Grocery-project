...
<body>
    ...
    <form method="get" action="loginprocess.jsp" class="login-form">
        <h3>Login Form</h3>
        <input type="email"  placeholder="Enter Email" name="email1" class="box">
        <input type="password"  placeholder="Enter Password" name="pass" class="box">

        <div id="create-btn"><p>Create Your Account <a href="#">Click Here</a></p></div>
        <input type="submit" value="Login" class="btn">
    </form>
    <form method="post" action="Account.jsp" class="create-account">
       ...
       <input type="text" placeholder="Enter Number..." name="cno" class="box">
       <input type="password" placeholder="Enter Password..." name="pass" class="box">
